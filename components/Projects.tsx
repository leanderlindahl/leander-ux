        ...
        {projects.map((project, index) => (
          ...
          >
            <motion.img
              ...
              alt="Packaging design: Survival kit"
            />
            <div className="space-y-10 px-0 md:px-10 max-w-6xl">
              ...
              <p className="text-lg text-center md:text-left">
                ...
                Aperiam blanditiis in temporibus saepe natus placeat odio,
                repellendus, hic omnis facere praesentium non dolore ducimus ea
                recusandae expedita voluptatem voluptates ab. Expedita, ipsa
                odit praesentium, magnam temporibus obcaecati aliquam non illum
                dolorem deserunt eum nobis culpa id delectus excepturi explicabo
                sint.
              </p>
            </div>
          </div>
